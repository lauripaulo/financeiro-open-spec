...
@transaction.atomic
def gerar_parcelas_da_compra(*, descricao, valor_total, total_parcelas, conta, data_compra):
    ...
    valor_parcela = (Decimal(valor_total) / Decimal(total_parcelas)).quantize(Decimal("0.01"), rounding=ROUND_HALF_UP)
