...
## Purpose
Definir as regras de vínculo bidirecional entre lançamentos que representam as duas
faces de uma mesma operação financeira (ex.: aporte em investimento + saída do banco).
